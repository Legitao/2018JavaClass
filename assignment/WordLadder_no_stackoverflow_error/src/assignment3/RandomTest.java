...
public class RandomTest {
	...
	public void test() {
		...
		while(t-- > 0)
		{
			int item1 = new Random().nextInt(size); // In real life, the Random object should be rather more shared than this
			...
			ArrayList<String> res = Main.getWordLadderDFS(start, end);
